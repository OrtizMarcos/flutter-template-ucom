                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(16.0),
                            child: Text(
                              "Estoy aquí para hacer tus finanzas\npersonales más fáciles 💰",
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyLarge!
                                  .copyWith(
                        ...
                        Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.all(16.0),
                            child: Text(
                              "¡Una tarjeta de débito y crédito inteligente que puede ayudarte a ahorrar más dinero! 💳",
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyLarge!
                                  .copyWith(
